...
function rolarDado() {
    ...
    // Remove ouvintes de evento dos botões de coluna
    document.getElementById('C1').removeEventListener('click', iniciarRodadaOponente);
    document.getElementById('C2').removeEventListener('click', iniciarRodadaOponente);
    document.getElementById('C3').removeEventListener('click', iniciarRodadaOponente);
}
...
function escolherColuna(coluna) {
    ...
    // Remover ouvintes de evento dos botões de coluna
